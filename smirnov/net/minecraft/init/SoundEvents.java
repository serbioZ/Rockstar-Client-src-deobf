...
{
    private static SoundEvent getRegisteredSoundEvent(final String llllllllllllIlllIlllIlIlIIllIIIl) {
        final SoundEvent llllllllllllIlllIlllIlIlIIllIIlI = SoundEvent.REGISTRY.getObject(new ResourceLocation(llllllllllllIlllIlllIlIlIIllIIIl));
        if (llllllllllllIlllIlllIlIlIIllIIlI == null) {
            throw new IllegalStateException("Invalid Sound requested: " + llllllllllllIlllIlllIlIlIIllIIIl);
        }
        return llllllllllllIlllIlllIlIlIIllIIlI;
    }
