...
public class Blocks
{
    ...
    @Nullable
    private static Block getRegisteredBlock(final String llllllllllllIIlIllIIIlIlIIIIIlII) {
        final Block llllllllllllIIlIllIIIlIlIIIIIlIl = Block.REGISTRY.getObject(new ResourceLocation(llllllllllllIIlIllIIIlIlIIIIIlII));
        if (!Blocks.CACHE.add(llllllllllllIIlIllIIIlIlIIIIIlIl)) {
            throw new IllegalStateException("Invalid Block requested: " + llllllllllllIIlIllIIIlIlIIIIIlII);
        }
        return llllllllllllIIlIllIIIlIlIIIIIlIl;
    }
}
