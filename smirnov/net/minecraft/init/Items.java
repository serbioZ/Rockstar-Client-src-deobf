...
public class Items
{
    ...
    private static Item getRegisteredItem(final String lllllllllllllIIIIlIllIllIIlIIIIl) {
        final Item lllllllllllllIIIIlIllIllIIlIIIlI = Item.REGISTRY.getObject(new ResourceLocation(lllllllllllllIIIIlIllIllIIlIIIIl));
        if (lllllllllllllIIIIlIllIllIIlIIIlI == null) {
            throw new IllegalStateException("Invalid Item requested: " + lllllllllllllIIIIlIllIllIIlIIIIl);
        }
        return lllllllllllllIIIIlIllIllIIlIIIlI;
    }
}
