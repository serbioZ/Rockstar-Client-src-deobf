...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    public void func_191965_a(final IBakedModel llllllllllllIIIIIIlIIlIllllllIlI, final int llllllllllllIIIIIIlIIlIlllllIllI) {
        this.func_191967_a(llllllllllllIIIIIIlIIlIllllllIlI, llllllllllllIIIIIIlIIlIlllllIllI, ItemStack.field_190927_a);
    }
    
    private void setupGuiTransform(final float llllllllllllIIIIIIlIIlIlIIIlIllI, final float llllllllllllIIIIIIlIIlIlIIIlIlIl, final boolean llllllllllllIIIIIIlIIlIlIIIllIII) {
        GlStateManager.translate(llllllllllllIIIIIIlIIlIlIIIlIllI, llllllllllllIIIIIIlIIlIlIIIlIlIl, 100.0f + this.zLevel);
        GlStateManager.translate(8.0f, 8.0f, 0.0f);
        GlStateManager.scale(1.0f, -1.0f, 1.0f);
        GlStateManager.scale(16.0f, 16.0f, 16.0f);
        if (llllllllllllIIIIIIlIIlIlIIIllIII) {
    ...
    private void registerItem(final Item llllllllllllIIIIIIlIIllIIIIIllII, final String llllllllllllIIIIIIlIIllIIIIIlIll) {
        this.registerItem(llllllllllllIIIIIIlIIllIIIIIllII, 0, llllllllllllIIIIIIlIIllIIIIIlIll);
    }
    
    private void func_191967_a(final IBakedModel llllllllllllIIIIIIlIIlIllllIlIII, final int llllllllllllIIIIIIlIIlIlllIllllI, final ItemStack llllllllllllIIIIIIlIIlIllllIIllI) {
        final Tessellator llllllllllllIIIIIIlIIlIllllIIlIl = Tessellator.getInstance();
        final BufferBuilder llllllllllllIIIIIIlIIlIllllIIlII = llllllllllllIIIIIIlIIlIllllIIlIl.getBuffer();
        final boolean llllllllllllIIIIIIlIIlIllllIIIll = Minecraft.getMinecraft().getTextureMapBlocks().isTextureBound();
        final boolean llllllllllllIIIIIIlIIlIllllIIIlI = Config.isMultiTexture() && llllllllllllIIIIIIlIIlIllllIIIll;
        if (llllllllllllIIIIIIlIIlIllllIIIlI) {
            llllllllllllIIIIIIlIIlIllllIIlII.setBlockLayer(BlockRenderLayer.SOLID);
        }
        llllllllllllIIIIIIlIIlIllllIIlII.begin(7, DefaultVertexFormats.ITEM);
        long llllllllllllIIIIIIlIIlIlllIlIlIl;
        for (int llllllllllllIIIIIIlIIlIlllIlIllI = ((EnumFacing[])(Object)(llllllllllllIIIIIIlIIlIlllIlIlIl = (long)(Object)EnumFacing.VALUES)).length, llllllllllllIIIIIIlIIlIlllIlIlll = 0; llllllllllllIIIIIIlIIlIlllIlIlll < llllllllllllIIIIIIlIIlIlllIlIllI; ++llllllllllllIIIIIIlIIlIlllIlIlll) {
            final EnumFacing llllllllllllIIIIIIlIIlIllllIIIIl = llllllllllllIIIIIIlIIlIlllIlIlIl[llllllllllllIIIIIIlIIlIlllIlIlll];
            this.func_191970_a(llllllllllllIIIIIIlIIlIllllIIlII, llllllllllllIIIIIIlIIlIllllIlIII.getQuads(null, llllllllllllIIIIIIlIIlIllllIIIIl, 0L), llllllllllllIIIIIIlIIlIlllIllllI, llllllllllllIIIIIIlIIlIllllIIllI);
        }
        this.func_191970_a(llllllllllllIIIIIIlIIlIllllIIlII, llllllllllllIIIIIIlIIlIllllIlIII.getQuads(null, null, 0L), llllllllllllIIIIIIlIIlIlllIllllI, llllllllllllIIIIIIlIIlIllllIIllI);
        llllllllllllIIIIIIlIIlIllllIIlIl.draw();
        if (llllllllllllIIIIIIlIIlIllllIIIlI) {
            llllllllllllIIIIIIlIIlIllllIIlII.setBlockLayer(null);
            GlStateManager.bindCurrentTexture();
        }
    }
    
    private void func_191961_a(final IBakedModel llllllllllllIIIIIIlIIllIIIIIIIll, final ItemStack llllllllllllIIIIIIlIIllIIIIIIIlI) {
        this.func_191967_a(llllllllllllIIIIIIlIIllIIIIIIIll, -1, llllllllllllIIIIIIlIIllIIIIIIIlI);
    }
    
    public void renderItem(final ItemStack llllllllllllIIIIIIlIIlIlllIlIIII, IBakedModel llllllllllllIIIIIIlIIlIlllIIllII) {
        if (!llllllllllllIIIIIIlIIlIlllIlIIII.isEmpty()) {
            GlStateManager.pushMatrix();
            GlStateManager.translate(-0.5f, -0.5f, -0.5f);
            if (((IBakedModel)llllllllllllIIIIIIlIIlIlllIIllII).isBuiltInRenderer()) {
                GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
                GlStateManager.enableRescaleNormal();
                TileEntityItemStackRenderer.instance.renderByItem(llllllllllllIIIIIIlIIlIlllIlIIII);
            }
            else {
                if (Config.isCustomItems()) {
                    llllllllllllIIIIIIlIIlIlllIIllII = CustomItems.getCustomItemModel(llllllllllllIIIIIIlIIlIlllIlIIII, (IBakedModel)llllllllllllIIIIIIlIIlIlllIIllII, this.modelLocation, false);
                    this.modelLocation = null;
                }
                this.func_191961_a((IBakedModel)llllllllllllIIIIIIlIIlIlllIIllII, llllllllllllIIIIIIlIIlIlllIlIIII);
                if (llllllllllllIIIIIIlIIlIlllIlIIII.hasEffect() && (!Config.isCustomItems() || !CustomItems.renderCustomEffect(this, llllllllllllIIIIIIlIIlIlllIlIIII, (IBakedModel)llllllllllllIIIIIIlIIlIlllIIllII))) {
                    this.renderEffect((IBakedModel)llllllllllllIIIIIIlIIlIlllIIllII);
                }
            }
    ...
    private void func_191969_a(final BufferBuilder llllllllllllIIIIIIlIIlIllIllIIlI, final BakedQuad llllllllllllIIIIIIlIIlIllIlIllIl, final int llllllllllllIIIIIIlIIlIllIlIllII) {
        if (llllllllllllIIIIIIlIIlIllIllIIlI.isMultiTexture()) {
            llllllllllllIIIIIIlIIlIllIllIIlI.addVertexData(llllllllllllIIIIIIlIIlIllIlIllIl.getVertexDataSingle());
            llllllllllllIIIIIIlIIlIllIllIIlI.putSprite(llllllllllllIIIIIIlIIlIllIlIllIl.getSprite());
        }
        else {
            llllllllllllIIIIIIlIIlIllIllIIlI.addVertexData(llllllllllllIIIIIIlIIlIllIlIllIl.getVertexData());
        }
        if (Reflector.ForgeHooksClient_putQuadColor.exists()) {
            Reflector.call(Reflector.ForgeHooksClient_putQuadColor, new Object[] { llllllllllllIIIIIIlIIlIllIllIIlI, llllllllllllIIIIIIlIIlIllIlIllIl, llllllllllllIIIIIIlIIlIllIlIllII });
        }
        else {
            llllllllllllIIIIIIlIIlIllIllIIlI.putColor4(llllllllllllIIIIIIlIIlIllIlIllII);
        }
        this.putQuadNormal(llllllllllllIIIIIIlIIlIllIllIIlI, llllllllllllIIIIIIlIIlIllIlIllIl);
    }
    ...
    public void renderItemOverlays(final FontRenderer llllllllllllIIIIIIlIIlIIlllIlIIl, final ItemStack llllllllllllIIIIIIlIIlIIlllIIIll, final int llllllllllllIIIIIIlIIlIIlllIIlll, final int llllllllllllIIIIIIlIIlIIlllIIllI) {
        this.renderItemOverlayIntoGUI(llllllllllllIIIIIIlIIlIIlllIlIIl, llllllllllllIIIIIIlIIlIIlllIIIll, llllllllllllIIIIIIlIIlIIlllIIlll, llllllllllllIIIIIIlIIlIIlllIIllI, null);
    }
    
    public void renderItemAndEffectIntoGUI(@Nullable final EntityLivingBase llllllllllllIIIIIIlIIlIIlllllllI, final ItemStack llllllllllllIIIIIIlIIlIIllllIlIl, final int llllllllllllIIIIIIlIIlIIllllllII, final int llllllllllllIIIIIIlIIlIIllllIIll) {
        if (!llllllllllllIIIIIIlIIlIIllllIlIl.isEmpty()) {
            this.zLevel += 50.0f;
            try {
                this.func_191962_a(llllllllllllIIIIIIlIIlIIllllIlIl, (float)llllllllllllIIIIIIlIIlIIllllllII, (float)llllllllllllIIIIIIlIIlIIllllIIll, this.getItemModelWithOverrides(llllllllllllIIIIIIlIIlIIllllIlIl, null, llllllllllllIIIIIIlIIlIIlllllllI));
            }
            catch (Throwable llllllllllllIIIIIIlIIlIIlllllIlI) {
                final CrashReport llllllllllllIIIIIIlIIlIIlllllIIl = CrashReport.makeCrashReport(llllllllllllIIIIIIlIIlIIlllllIlI, "Rendering item");
                final CrashReportCategory llllllllllllIIIIIIlIIlIIlllllIII = llllllllllllIIIIIIlIIlIIlllllIIl.makeCategory("Item being rendered");
                llllllllllllIIIIIIlIIlIIlllllIII.setDetail("Item Type", new ICrashReportDetail<String>() {
                    @Override
                    public String call() throws Exception {
                        return String.valueOf(llllllllllllIIIIIIlIIlIIllllIlIl.getItem());
                    }
                });
                llllllllllllIIIIIIlIIlIIlllllIII.setDetail("Item Aux", new ICrashReportDetail<String>() {
                    @Override
                    public String call() throws Exception {
                        return String.valueOf(llllllllllllIIIIIIlIIlIIllllIlIl.getMetadata());
                    }
                });
                llllllllllllIIIIIIlIIlIIlllllIII.setDetail("Item NBT", new ICrashReportDetail<String>() {
                    @Override
                    public String call() throws Exception {
                        return String.valueOf(llllllllllllIIIIIIlIIlIIllllIlIl.getTagCompound());
                    }
                });
                llllllllllllIIIIIIlIIlIIlllllIII.setDetail("Item Foil", new ICrashReportDetail<String>() {
                    @Override
                    public String call() throws Exception {
                        return String.valueOf(llllllllllllIIIIIIlIIlIIllllIlIl.hasEffect());
                    }
                });
                throw new ReportedException(llllllllllllIIIIIIlIIlIIlllllIIl);
            }
            this.zLevel -= 50.0f;
        }
    }
    ...
    private void registerItems() {
        ...
        final int llllllllllllIIIIIIlIIlIIIlIIIIlI;
        final String llllllllllllIIIIIIlIIlIIIlIIIIll = (String)((EnumDyeColor[])(Object)(llllllllllllIIIIIIlIIlIIIlIIIIlI = (int)(Object)EnumDyeColor.values())).length;
        for (final EnumDyeColor llllllllllllIIIIIIlIIlIIIlIIIlll : llllllllllllIIIIIIlIIlIIIlIIIIlI) {
            this.registerBlock(Blocks.field_192443_dR, llllllllllllIIIIIIlIIlIIIlIIIlll.getMetadata(), String.valueOf(llllllllllllIIIIIIlIIlIIIlIIIlll.func_192396_c()) + "_concrete");
            this.registerBlock(Blocks.field_192444_dS, llllllllllllIIIIIIlIIlIIIlIIIlll.getMetadata(), String.valueOf(llllllllllllIIIIIIlIIlIIIlIIIlll.func_192396_c()) + "_concrete_powder");
        }
        ...
        this.itemModelMesher.register(Items.SPAWN_EGG, new ItemMeshDefinition() {
            @Override
            public ModelResourceLocation getModelLocation(final ItemStack lllllllllllllIIlIIIIIlIllIlIllIl) {
        ...
        this.itemModelMesher.register(Items.BANNER, new ItemMeshDefinition() {
            @Override
            public ModelResourceLocation getModelLocation(final ItemStack lllllllllllllIIIllIIIIIlIllIlllI) {
                return new ModelResourceLocation("banner", "inventory");
            }
        });
        this.itemModelMesher.register(Items.BED, new ItemMeshDefinition() {
            @Override
            public ModelResourceLocation getModelLocation(final ItemStack lllllllllllIIIlllllIIIllIIlIlllI) {
                return new ModelResourceLocation("bed", "inventory");
            }
        });
        this.itemModelMesher.register(Items.SHIELD, new ItemMeshDefinition() {
            @Override
            public ModelResourceLocation getModelLocation(final ItemStack llllllllllllIllIIllIIllIIlIIIIll) {
        ...
        this.itemModelMesher.register(Items.ENCHANTED_BOOK, new ItemMeshDefinition() {
            @Override
            public ModelResourceLocation getModelLocation(final ItemStack lllllllllllIIlIIIIlllIIIlIIllIlI) {
        ...
        this.itemModelMesher.register(Items.FILLED_MAP, new ItemMeshDefinition() {
            @Override
            public ModelResourceLocation getModelLocation(final ItemStack llllllllllIlllIlIllIlIIllllIIllI) {
    ...
    private boolean isThereOneNegativeScale(final ItemTransformVec3f llllllllllllIIIIIIlIIlIlIIllllII) {
        return llllllllllllIIIIIIlIIlIlIIllllII.scale.x < 0.0f ^ llllllllllllIIIIIIlIIlIlIIllllII.scale.y < 0.0f ^ llllllllllllIIIIIIlIIlIlIIllllII.scale.z < 0.0f;
    }
    
    public void renderItemOverlayIntoGUI(final net.minecraft.client.gui.FontRenderer llllllllllllIIIIIIlIIlIIIlllIlll, final ItemStack llllllllllllIIIIIIlIIlIIIlllIllI, final int llllllllllllIIIIIIlIIlIIIlllIlIl, final int llllllllllllIIIIIIlIIlIIlIIIlIlI, @Nullable final String llllllllllllIIIIIIlIIlIIIlllIIll) {
        if (!llllllllllllIIIIIIlIIlIIIlllIllI.isEmpty()) {
            if (llllllllllllIIIIIIlIIlIIIlllIllI.getCount() != 1 || llllllllllllIIIIIIlIIlIIIlllIIll != null) {
                final String llllllllllllIIIIIIlIIlIIlIIIlIII = (llllllllllllIIIIIIlIIlIIIlllIIll == null) ? String.valueOf(llllllllllllIIIIIIlIIlIIIlllIllI.getCount()) : llllllllllllIIIIIIlIIlIIIlllIIll;
                GlStateManager.disableLighting();
                GlStateManager.disableDepth();
                GlStateManager.disableBlend();
                llllllllllllIIIIIIlIIlIIIlllIlll.drawStringWithShadow(llllllllllllIIIIIIlIIlIIlIIIlIII, (float)(llllllllllllIIIIIIlIIlIIIlllIlIl + 19 - 2 - llllllllllllIIIIIIlIIlIIIlllIlll.getStringWidth(llllllllllllIIIIIIlIIlIIlIIIlIII)), (float)(llllllllllllIIIIIIlIIlIIlIIIlIlI + 6 + 3), 16777215);
                GlStateManager.enableLighting();
                GlStateManager.enableDepth();
                GlStateManager.enableBlend();
            }
            if (ReflectorForge.isItemDamaged(llllllllllllIIIIIIlIIlIIIlllIllI)) {
                GlStateManager.disableLighting();
                GlStateManager.disableDepth();
                GlStateManager.disableTexture2D();
                GlStateManager.disableAlpha();
                GlStateManager.disableBlend();
                final Tessellator llllllllllllIIIIIIlIIlIIlIIIIlll = Tessellator.getInstance();
                final BufferBuilder llllllllllllIIIIIIlIIlIIlIIIIllI = llllllllllllIIIIIIlIIlIIlIIIIlll.getBuffer();
                final float llllllllllllIIIIIIlIIlIIlIIIIlIl = (float)llllllllllllIIIIIIlIIlIIIlllIllI.getItemDamage();
                final float llllllllllllIIIIIIlIIlIIlIIIIlII = (float)llllllllllllIIIIIIlIIlIIIlllIllI.getMaxDamage();
                final float llllllllllllIIIIIIlIIlIIlIIIIIll = Math.max(0.0f, (llllllllllllIIIIIIlIIlIIlIIIIlII - llllllllllllIIIIIIlIIlIIlIIIIlIl) / llllllllllllIIIIIIlIIlIIlIIIIlII);
                int llllllllllllIIIIIIlIIlIIlIIIIIlI = Math.round(13.0f - llllllllllllIIIIIIlIIlIIlIIIIlIl * 13.0f / llllllllllllIIIIIIlIIlIIlIIIIlII);
                int llllllllllllIIIIIIlIIlIIlIIIIIIl = MathHelper.hsvToRGB(llllllllllllIIIIIIlIIlIIlIIIIIll / 3.0f, 1.0f, 1.0f);
                if (Reflector.ForgeItem_getDurabilityForDisplay.exists() && Reflector.ForgeItem_getRGBDurabilityForDisplay.exists()) {
                    final double llllllllllllIIIIIIlIIlIIlIIIIIII = Reflector.callDouble((Object)llllllllllllIIIIIIlIIlIIIlllIllI.getItem(), Reflector.ForgeItem_getDurabilityForDisplay, new Object[] { llllllllllllIIIIIIlIIlIIIlllIllI });
                    final int llllllllllllIIIIIIlIIlIIIlllllll = Reflector.callInt((Object)llllllllllllIIIIIIlIIlIIIlllIllI.getItem(), Reflector.ForgeItem_getRGBDurabilityForDisplay, new Object[] { llllllllllllIIIIIIlIIlIIIlllIllI });
                    llllllllllllIIIIIIlIIlIIlIIIIIlI = Math.round(13.0f - (float)llllllllllllIIIIIIlIIlIIlIIIIIII * 13.0f);
                    llllllllllllIIIIIIlIIlIIlIIIIIIl = llllllllllllIIIIIIlIIlIIIlllllll;
                }
                if (Config.isCustomColors()) {
                    llllllllllllIIIIIIlIIlIIlIIIIIIl = CustomColors.getDurabilityColor(llllllllllllIIIIIIlIIlIIlIIIIIll, llllllllllllIIIIIIlIIlIIlIIIIIIl);
                }
                if (Reflector.ForgeItem_getDurabilityForDisplay.exists() && Reflector.ForgeItem_getRGBDurabilityForDisplay.exists()) {
                    final double llllllllllllIIIIIIlIIlIIIllllllI = Reflector.callDouble((Object)llllllllllllIIIIIIlIIlIIIlllIllI.getItem(), Reflector.ForgeItem_getDurabilityForDisplay, new Object[] { llllllllllllIIIIIIlIIlIIIlllIllI });
                    final int llllllllllllIIIIIIlIIlIIIlllllIl = Reflector.callInt((Object)llllllllllllIIIIIIlIIlIIIlllIllI.getItem(), Reflector.ForgeItem_getRGBDurabilityForDisplay, new Object[] { llllllllllllIIIIIIlIIlIIIlllIllI });
                    llllllllllllIIIIIIlIIlIIlIIIIIlI = Math.round(13.0f - (float)llllllllllllIIIIIIlIIlIIIllllllI * 13.0f);
                    llllllllllllIIIIIIlIIlIIlIIIIIIl = llllllllllllIIIIIIlIIlIIIlllllIl;
                }
                if (Config.isCustomColors()) {
                    llllllllllllIIIIIIlIIlIIlIIIIIIl = CustomColors.getDurabilityColor(llllllllllllIIIIIIlIIlIIlIIIIIll, llllllllllllIIIIIIlIIlIIlIIIIIIl);
                }
                this.draw(llllllllllllIIIIIIlIIlIIlIIIIllI, llllllllllllIIIIIIlIIlIIIlllIlIl + 2, llllllllllllIIIIIIlIIlIIlIIIlIlI + 13, 13, 2, 0, 0, 0, 255);
                this.draw(llllllllllllIIIIIIlIIlIIlIIIIllI, llllllllllllIIIIIIlIIlIIIlllIlIl + 2, llllllllllllIIIIIIlIIlIIlIIIlIlI + 13, llllllllllllIIIIIIlIIlIIlIIIIIlI, 1, llllllllllllIIIIIIlIIlIIlIIIIIIl >> 16 & 0xFF, llllllllllllIIIIIIlIIlIIlIIIIIIl >> 8 & 0xFF, llllllllllllIIIIIIlIIlIIlIIIIIIl & 0xFF, 255);
                GlStateManager.enableBlend();
            ...
            final EntityPlayerSP llllllllllllIIIIIIlIIlIIIlllllII = Minecraft.getMinecraft().player;
            final float llllllllllllIIIIIIlIIlIIIllllIll = (llllllllllllIIIIIIlIIlIIIlllllII == null) ? 0.0f : llllllllllllIIIIIIlIIlIIIlllllII.getCooldownTracker().getCooldown(llllllllllllIIIIIIlIIlIIIlllIllI.getItem(), Minecraft.getMinecraft().getRenderPartialTicks());
            if (llllllllllllIIIIIIlIIlIIIllllIll > 0.0f) {
                GlStateManager.disableLighting();
                GlStateManager.disableDepth();
                GlStateManager.disableTexture2D();
                final Tessellator llllllllllllIIIIIIlIIlIIIllllIlI = Tessellator.getInstance();
                final BufferBuilder llllllllllllIIIIIIlIIlIIIllllIIl = llllllllllllIIIIIIlIIlIIIllllIlI.getBuffer();
                this.draw(llllllllllllIIIIIIlIIlIIIllllIIl, llllllllllllIIIIIIlIIlIIIlllIlIl, llllllllllllIIIIIIlIIlIIlIIIlIlI + MathHelper.floor(16.0f * (1.0f - llllllllllllIIIIIIlIIlIIIllllIll)), 16, MathHelper.ceil(16.0f * llllllllllllIIIIIIlIIlIIIllllIll), 255, 255, 255, 127);
                GlStateManager.enableTexture2D();
                GlStateManager.enableLighting();
                GlStateManager.enableDepth();
            }
    ...
    public void renderItemAndEffectIntoGUI(final ItemStack llllllllllllIIIIIIlIIlIlIIIIlIlI, final int llllllllllllIIIIIIlIIlIlIIIIlIIl, final int llllllllllllIIIIIIlIIlIlIIIIllII) {
        this.renderItemAndEffectIntoGUI(Minecraft.getMinecraft().player, llllllllllllIIIIIIlIIlIlIIIIlIlI, llllllllllllIIIIIIlIIlIlIIIIlIIl, llllllllllllIIIIIIlIIlIlIIIIllII);
    }
    
    public void renderItemOverlayIntoGUI(final FontRenderer llllllllllllIIIIIIlIIlIIllIlIIII, final ItemStack llllllllllllIIIIIIlIIlIIlIlllIIl, final int llllllllllllIIIIIIlIIlIIlIlllIII, final int llllllllllllIIIIIIlIIlIIllIIllIl, @Nullable final String llllllllllllIIIIIIlIIlIIlIllIllI) {
        if (!llllllllllllIIIIIIlIIlIIlIlllIIl.isEmpty()) {
            if (llllllllllllIIIIIIlIIlIIlIlllIIl.getCount() != 1 || llllllllllllIIIIIIlIIlIIlIllIllI != null) {
                final String llllllllllllIIIIIIlIIlIIllIIlIll = (llllllllllllIIIIIIlIIlIIlIllIllI == null) ? String.valueOf(llllllllllllIIIIIIlIIlIIlIlllIIl.getCount()) : llllllllllllIIIIIIlIIlIIlIllIllI;
                GlStateManager.disableLighting();
                GlStateManager.disableDepth();
                GlStateManager.disableBlend();
                llllllllllllIIIIIIlIIlIIllIlIIII.drawStringWithShadow(llllllllllllIIIIIIlIIlIIllIIlIll, (float)(llllllllllllIIIIIIlIIlIIlIlllIII + 19 - 2 - llllllllllllIIIIIIlIIlIIllIlIIII.getStringWidth(llllllllllllIIIIIIlIIlIIllIIlIll)), (float)(llllllllllllIIIIIIlIIlIIllIIllIl + 6 + 3), 16777215);
                GlStateManager.enableLighting();
                GlStateManager.enableDepth();
                GlStateManager.enableBlend();
            }
            if (ReflectorForge.isItemDamaged(llllllllllllIIIIIIlIIlIIlIlllIIl)) {
                GlStateManager.disableLighting();
                GlStateManager.disableDepth();
                GlStateManager.disableTexture2D();
                GlStateManager.disableAlpha();
                GlStateManager.disableBlend();
                final Tessellator llllllllllllIIIIIIlIIlIIllIIlIlI = Tessellator.getInstance();
                final BufferBuilder llllllllllllIIIIIIlIIlIIllIIlIIl = llllllllllllIIIIIIlIIlIIllIIlIlI.getBuffer();
                final float llllllllllllIIIIIIlIIlIIllIIlIII = (float)llllllllllllIIIIIIlIIlIIlIlllIIl.getItemDamage();
                final float llllllllllllIIIIIIlIIlIIllIIIlll = (float)llllllllllllIIIIIIlIIlIIlIlllIIl.getMaxDamage();
                final float llllllllllllIIIIIIlIIlIIllIIIllI = Math.max(0.0f, (llllllllllllIIIIIIlIIlIIllIIIlll - llllllllllllIIIIIIlIIlIIllIIlIII) / llllllllllllIIIIIIlIIlIIllIIIlll);
                int llllllllllllIIIIIIlIIlIIllIIIlIl = Math.round(13.0f - llllllllllllIIIIIIlIIlIIllIIlIII * 13.0f / llllllllllllIIIIIIlIIlIIllIIIlll);
                int llllllllllllIIIIIIlIIlIIllIIIlII = MathHelper.hsvToRGB(llllllllllllIIIIIIlIIlIIllIIIllI / 3.0f, 1.0f, 1.0f);
                if (Reflector.ForgeItem_getDurabilityForDisplay.exists() && Reflector.ForgeItem_getRGBDurabilityForDisplay.exists()) {
                    final double llllllllllllIIIIIIlIIlIIllIIIIll = Reflector.callDouble((Object)llllllllllllIIIIIIlIIlIIlIlllIIl.getItem(), Reflector.ForgeItem_getDurabilityForDisplay, new Object[] { llllllllllllIIIIIIlIIlIIlIlllIIl });
                    final int llllllllllllIIIIIIlIIlIIllIIIIlI = Reflector.callInt((Object)llllllllllllIIIIIIlIIlIIlIlllIIl.getItem(), Reflector.ForgeItem_getRGBDurabilityForDisplay, new Object[] { llllllllllllIIIIIIlIIlIIlIlllIIl });
                    llllllllllllIIIIIIlIIlIIllIIIlIl = Math.round(13.0f - (float)llllllllllllIIIIIIlIIlIIllIIIIll * 13.0f);
                    llllllllllllIIIIIIlIIlIIllIIIlII = llllllllllllIIIIIIlIIlIIllIIIIlI;
                }
                if (Config.isCustomColors()) {
                    llllllllllllIIIIIIlIIlIIllIIIlII = CustomColors.getDurabilityColor(llllllllllllIIIIIIlIIlIIllIIIllI, llllllllllllIIIIIIlIIlIIllIIIlII);
                }
                if (Reflector.ForgeItem_getDurabilityForDisplay.exists() && Reflector.ForgeItem_getRGBDurabilityForDisplay.exists()) {
                    final double llllllllllllIIIIIIlIIlIIllIIIIIl = Reflector.callDouble((Object)llllllllllllIIIIIIlIIlIIlIlllIIl.getItem(), Reflector.ForgeItem_getDurabilityForDisplay, new Object[] { llllllllllllIIIIIIlIIlIIlIlllIIl });
                    final int llllllllllllIIIIIIlIIlIIllIIIIII = Reflector.callInt((Object)llllllllllllIIIIIIlIIlIIlIlllIIl.getItem(), Reflector.ForgeItem_getRGBDurabilityForDisplay, new Object[] { llllllllllllIIIIIIlIIlIIlIlllIIl });
                    llllllllllllIIIIIIlIIlIIllIIIlIl = Math.round(13.0f - (float)llllllllllllIIIIIIlIIlIIllIIIIIl * 13.0f);
                    llllllllllllIIIIIIlIIlIIllIIIlII = llllllllllllIIIIIIlIIlIIllIIIIII;
                }
                if (Config.isCustomColors()) {
                    llllllllllllIIIIIIlIIlIIllIIIlII = CustomColors.getDurabilityColor(llllllllllllIIIIIIlIIlIIllIIIllI, llllllllllllIIIIIIlIIlIIllIIIlII);
                }
                this.draw(llllllllllllIIIIIIlIIlIIllIIlIIl, llllllllllllIIIIIIlIIlIIlIlllIII + 2, llllllllllllIIIIIIlIIlIIllIIllIl + 13, 13, 2, 0, 0, 0, 255);
                this.draw(llllllllllllIIIIIIlIIlIIllIIlIIl, llllllllllllIIIIIIlIIlIIlIlllIII + 2, llllllllllllIIIIIIlIIlIIllIIllIl + 13, llllllllllllIIIIIIlIIlIIllIIIlIl, 1, llllllllllllIIIIIIlIIlIIllIIIlII >> 16 & 0xFF, llllllllllllIIIIIIlIIlIIllIIIlII >> 8 & 0xFF, llllllllllllIIIIIIlIIlIIllIIIlII & 0xFF, 255);
                GlStateManager.enableBlend();
                GlStateManager.enableAlpha();
                GlStateManager.enableTexture2D();
                GlStateManager.enableLighting();
            ...
            final EntityPlayerSP llllllllllllIIIIIIlIIlIIlIllllll = Minecraft.getMinecraft().player;
            final float llllllllllllIIIIIIlIIlIIlIlllllI = (llllllllllllIIIIIIlIIlIIlIllllll == null) ? 0.0f : llllllllllllIIIIIIlIIlIIlIllllll.getCooldownTracker().getCooldown(llllllllllllIIIIIIlIIlIIlIlllIIl.getItem(), Minecraft.getMinecraft().getRenderPartialTicks());
            if (llllllllllllIIIIIIlIIlIIlIlllllI > 0.0f) {
                GlStateManager.disableLighting();
                GlStateManager.disableDepth();
                GlStateManager.disableTexture2D();
                final Tessellator llllllllllllIIIIIIlIIlIIlIllllIl = Tessellator.getInstance();
                final BufferBuilder llllllllllllIIIIIIlIIlIIlIllllII = llllllllllllIIIIIIlIIlIIlIllllIl.getBuffer();
                this.draw(llllllllllllIIIIIIlIIlIIlIllllII, llllllllllllIIIIIIlIIlIIlIlllIII, llllllllllllIIIIIIlIIlIIllIIllIl + MathHelper.floor(16.0f * (1.0f - llllllllllllIIIIIIlIIlIIlIlllllI)), 16, MathHelper.ceil(16.0f * llllllllllllIIIIIIlIIlIIlIlllllI), 255, 255, 255, 127);
                GlStateManager.enableTexture2D();
                GlStateManager.enableLighting();
                GlStateManager.enableDepth();
            }
    ...
    public void renderItem(final ItemStack llllllllllllIIIIIIlIIlIlIlIlIlIl, final EntityLivingBase llllllllllllIIIIIIlIIlIlIlIllIlI, final ItemCameraTransforms.TransformType llllllllllllIIIIIIlIIlIlIlIlIIll, final boolean llllllllllllIIIIIIlIIlIlIlIlIIlI) {
        if (!llllllllllllIIIIIIlIIlIlIlIlIlIl.isEmpty() && llllllllllllIIIIIIlIIlIlIlIllIlI != null) {
            final IBakedModel llllllllllllIIIIIIlIIlIlIlIlIlll = this.getItemModelWithOverrides(llllllllllllIIIIIIlIIlIlIlIlIlIl, llllllllllllIIIIIIlIIlIlIlIllIlI.world, llllllllllllIIIIIIlIIlIlIlIllIlI);
            this.renderItemModel(llllllllllllIIIIIIlIIlIlIlIlIlIl, llllllllllllIIIIIIlIIlIlIlIlIlll, llllllllllllIIIIIIlIIlIlIlIlIIll, llllllllllllIIIIIIlIIlIlIlIlIIlI);
        }
    }
    
    public void renderItem(final ItemStack llllllllllllIIIIIIlIIlIlIllllIll, final ItemCameraTransforms.TransformType llllllllllllIIIIIIlIIlIlIllllllI) {
        if (!llllllllllllIIIIIIlIIlIlIllllIll.isEmpty()) {
            final IBakedModel llllllllllllIIIIIIlIIlIlIlllllIl = this.getItemModelWithOverrides(llllllllllllIIIIIIlIIlIlIllllIll, null, null);
            this.renderItemModel(llllllllllllIIIIIIlIIlIlIllllIll, llllllllllllIIIIIIlIIlIlIlllllIl, llllllllllllIIIIIIlIIlIlIllllllI, false);
        }
    }
    ...
    private void registerBlock(final Block llllllllllllIIIIIIlIIllIIIIlIlIl, final String llllllllllllIIIIIIlIIllIIIIlIlII) {
        this.registerBlock(llllllllllllIIIIIIlIIllIIIIlIlIl, 0, llllllllllllIIIIIIlIIllIIIIlIlII);
    }
    
    protected void registerItem(final Item llllllllllllIIIIIIlIIllIIIlIllII, final int llllllllllllIIIIIIlIIllIIIlIIlll, final String llllllllllllIIIIIIlIIllIIIlIIllI) {
        this.itemModelMesher.register(llllllllllllIIIIIIlIIllIIIlIllII, llllllllllllIIIIIIlIIllIIIlIIlll, new ModelResourceLocation(llllllllllllIIIIIIlIIllIIIlIIllI, "inventory"));
    }
    
    private void func_191970_a(final BufferBuilder llllllllllllIIIIIIlIIlIllIlIIIII, final List<BakedQuad> llllllllllllIIIIIIlIIlIllIIlIlIl, final int llllllllllllIIIIIIlIIlIllIIlIlII, final ItemStack llllllllllllIIIIIIlIIlIllIIlIIll) {
        final boolean llllllllllllIIIIIIlIIlIllIIlllII = llllllllllllIIIIIIlIIlIllIIlIlII == -1 && !llllllllllllIIIIIIlIIlIllIIlIIll.isEmpty();
        for (int llllllllllllIIIIIIlIIlIllIIllIll = 0, llllllllllllIIIIIIlIIlIllIIllIlI = llllllllllllIIIIIIlIIlIllIIlIlIl.size(); llllllllllllIIIIIIlIIlIllIIllIll < llllllllllllIIIIIIlIIlIllIIllIlI; ++llllllllllllIIIIIIlIIlIllIIllIll) {
            final BakedQuad llllllllllllIIIIIIlIIlIllIIllIIl = llllllllllllIIIIIIlIIlIllIIlIlIl.get(llllllllllllIIIIIIlIIlIllIIllIll);
            int llllllllllllIIIIIIlIIlIllIIllIII = llllllllllllIIIIIIlIIlIllIIlIlII;
            if (llllllllllllIIIIIIlIIlIllIIlllII && llllllllllllIIIIIIlIIlIllIIllIIl.hasTintIndex()) {
                llllllllllllIIIIIIlIIlIllIIllIII = this.itemColors.getColorFromItemstack(llllllllllllIIIIIIlIIlIllIIlIIll, llllllllllllIIIIIIlIIlIllIIllIIl.getTintIndex());
                if (Config.isCustomColors()) {
                    llllllllllllIIIIIIlIIlIllIIllIII = CustomColors.getColorFromItemStack(llllllllllllIIIIIIlIIlIllIIlIIll, llllllllllllIIIIIIlIIlIllIIllIIl.getTintIndex(), llllllllllllIIIIIIlIIlIllIIllIII);
                }
                if (EntityRenderer.anaglyphEnable) {
                    llllllllllllIIIIIIlIIlIllIIllIII = TextureUtil.anaglyphColor(llllllllllllIIIIIIlIIlIllIIllIII);
                }
                llllllllllllIIIIIIlIIlIllIIllIII |= 0xFF000000;
            }
            this.func_191969_a(llllllllllllIIIIIIlIIlIllIlIIIII, llllllllllllIIIIIIlIIlIllIIllIIl, llllllllllllIIIIIIlIIlIllIIllIII);
        }
    }
    
    protected void func_191962_a(final ItemStack llllllllllllIIIIIIlIIlIlIIlIIIll, final float llllllllllllIIIIIIlIIlIlIIlIIlll, final float llllllllllllIIIIIIlIIlIlIIlIIllI, IBakedModel llllllllllllIIIIIIlIIlIlIIlIIIII) {
        ...
        GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
        this.setupGuiTransform(llllllllllllIIIIIIlIIlIlIIlIIlll, llllllllllllIIIIIIlIIlIlIIlIIllI, ((IBakedModel)llllllllllllIIIIIIlIIlIlIIlIIIII).isGui3d());
        if (Reflector.ForgeHooksClient_handleCameraTransforms.exists()) {
            llllllllllllIIIIIIlIIlIlIIlIIIII = Reflector.call(Reflector.ForgeHooksClient_handleCameraTransforms, new Object[] { llllllllllllIIIIIIlIIlIlIIlIIIII, ItemCameraTransforms.TransformType.GUI, false });
        }
        else {
            ((IBakedModel)llllllllllllIIIIIIlIIlIlIIlIIIII).getItemCameraTransforms().applyTransform(ItemCameraTransforms.TransformType.GUI);
        }
        this.renderItem(llllllllllllIIIIIIlIIlIlIIlIIIll, (IBakedModel)llllllllllllIIIIIIlIIlIlIIlIIIII);
        GlStateManager.disableAlpha();
    ...
    private void draw(final BufferBuilder llllllllllllIIIIIIlIIlIIIlIlllll, final int llllllllllllIIIIIIlIIlIIIlIlIlIl, final int llllllllllllIIIIIIlIIlIIIlIlIlII, final int llllllllllllIIIIIIlIIlIIIlIlllII, final int llllllllllllIIIIIIlIIlIIIlIlIIlI, final int llllllllllllIIIIIIlIIlIIIlIllIlI, final int llllllllllllIIIIIIlIIlIIIlIllIIl, final int llllllllllllIIIIIIlIIlIIIlIllIII, final int llllllllllllIIIIIIlIIlIIIlIlIlll) {
        llllllllllllIIIIIIlIIlIIIlIlllll.begin(7, DefaultVertexFormats.POSITION_COLOR);
        llllllllllllIIIIIIlIIlIIIlIlllll.pos(llllllllllllIIIIIIlIIlIIIlIlIlIl + 0, llllllllllllIIIIIIlIIlIIIlIlIlII + 0, 0.0).color(llllllllllllIIIIIIlIIlIIIlIllIlI, llllllllllllIIIIIIlIIlIIIlIllIIl, llllllllllllIIIIIIlIIlIIIlIllIII, llllllllllllIIIIIIlIIlIIIlIlIlll).endVertex();
        llllllllllllIIIIIIlIIlIIIlIlllll.pos(llllllllllllIIIIIIlIIlIIIlIlIlIl + 0, llllllllllllIIIIIIlIIlIIIlIlIlII + llllllllllllIIIIIIlIIlIIIlIlIIlI, 0.0).color(llllllllllllIIIIIIlIIlIIIlIllIlI, llllllllllllIIIIIIlIIlIIIlIllIIl, llllllllllllIIIIIIlIIlIIIlIllIII, llllllllllllIIIIIIlIIlIIIlIlIlll).endVertex();
        llllllllllllIIIIIIlIIlIIIlIlllll.pos(llllllllllllIIIIIIlIIlIIIlIlIlIl + llllllllllllIIIIIIlIIlIIIlIlllII, llllllllllllIIIIIIlIIlIIIlIlIlII + llllllllllllIIIIIIlIIlIIIlIlIIlI, 0.0).color(llllllllllllIIIIIIlIIlIIIlIllIlI, llllllllllllIIIIIIlIIlIIIlIllIIl, llllllllllllIIIIIIlIIlIIIlIllIII, llllllllllllIIIIIIlIIlIIIlIlIlll).endVertex();
        llllllllllllIIIIIIlIIlIIIlIlllll.pos(llllllllllllIIIIIIlIIlIIIlIlIlIl + llllllllllllIIIIIIlIIlIIIlIlllII, llllllllllllIIIIIIlIIlIIIlIlIlII + 0, 0.0).color(llllllllllllIIIIIIlIIlIIIlIllIlI, llllllllllllIIIIIIlIIlIIIlIllIIl, llllllllllllIIIIIIlIIlIIIlIllIII, llllllllllllIIIIIIlIIlIIIlIlIlll).endVertex();
        Tessellator.getInstance().draw();
    }
    
    @Override
    public void onResourceManagerReload(final IResourceManager llllllllllllIIIIIIlIIlIIIIllllll) {
        this.itemModelMesher.rebuildCache();
    }
    
    private void putQuadNormal(final BufferBuilder llllllllllllIIIIIIlIIlIllIllllIl, final BakedQuad llllllllllllIIIIIIlIIlIllIllllII) {
        final Vec3i llllllllllllIIIIIIlIIlIllIlllIll = llllllllllllIIIIIIlIIlIllIllllII.getFace().getDirectionVec();
        llllllllllllIIIIIIlIIlIllIllllIl.putNormal((float)llllllllllllIIIIIIlIIlIllIlllIll.getX(), (float)llllllllllllIIIIIIlIIlIllIlllIll.getY(), (float)llllllllllllIIIIIIlIIlIllIlllIll.getZ());
    }
    
    public RenderItem(final TextureManager llllllllllllIIIIIIlIIllIIIllIlll, final ModelManager llllllllllllIIIIIIlIIllIIIllIllI, final ItemColors llllllllllllIIIIIIlIIllIIIllIlIl) {
        this.notRenderingEffectsInGUI = true;
        this.modelLocation = null;
        this.renderItemGui = false;
        this.modelManager = null;
        this.textureManager = llllllllllllIIIIIIlIIllIIIllIlll;
        this.modelManager = llllllllllllIIIIIIlIIllIIIllIllI;
        if (Reflector.ItemModelMesherForge_Constructor.exists()) {
            this.itemModelMesher = (ItemModelMesher)Reflector.newInstance(Reflector.ItemModelMesherForge_Constructor, new Object[] { llllllllllllIIIIIIlIIllIIIllIllI });
        }
        else {
            this.itemModelMesher = new ItemModelMesher(llllllllllllIIIIIIlIIllIIIllIllI);
        }
        this.registerItems();
        this.itemColors = llllllllllllIIIIIIlIIllIIIllIlIl;
    }
    
    public void renderItemOverlays(final net.minecraft.client.gui.FontRenderer llllllllllllIIIIIIlIIlIIlIlIIllI, final ItemStack llllllllllllIIIIIIlIIlIIlIlIIlIl, final int llllllllllllIIIIIIlIIlIIlIIlllll, final int llllllllllllIIIIIIlIIlIIlIlIIIll) {
        this.renderItemOverlayIntoGUI(llllllllllllIIIIIIlIIlIIlIlIIllI, llllllllllllIIIIIIlIIlIIlIlIIlIl, llllllllllllIIIIIIlIIlIIlIIlllll, llllllllllllIIIIIIlIIlIIlIlIIIll, null);
    }
    
    protected void renderItemModel(final ItemStack llllllllllllIIIIIIlIIlIlIlIIlIIl, IBakedModel llllllllllllIIIIIIlIIlIlIlIIIIlI, final ItemCameraTransforms.TransformType llllllllllllIIIIIIlIIlIlIlIIIIIl, final boolean llllllllllllIIIIIIlIIlIlIlIIIIII) {
        if (!llllllllllllIIIIIIlIIlIlIlIIlIIl.isEmpty()) {
            this.textureManager.bindTexture(TextureMap.LOCATION_BLOCKS_TEXTURE);
            this.textureManager.getTexture(TextureMap.LOCATION_BLOCKS_TEXTURE).setBlurMipmap(false, false);
            GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
            GlStateManager.enableRescaleNormal();
            ...
            GlStateManager.pushMatrix();
            if (Reflector.ForgeHooksClient_handleCameraTransforms.exists()) {
                llllllllllllIIIIIIlIIlIlIlIIIIlI = Reflector.call(Reflector.ForgeHooksClient_handleCameraTransforms, new Object[] { llllllllllllIIIIIIlIIlIlIlIIIIlI, llllllllllllIIIIIIlIIlIlIlIIIIIl, llllllllllllIIIIIIlIIlIlIlIIIIII });
            }
            else {
                final ItemCameraTransforms llllllllllllIIIIIIlIIlIlIlIIIlIl = ((IBakedModel)llllllllllllIIIIIIlIIlIlIlIIIIlI).getItemCameraTransforms();
                ItemCameraTransforms.applyTransformSide(llllllllllllIIIIIIlIIlIlIlIIIlIl.getTransform(llllllllllllIIIIIIlIIlIlIlIIIIIl), llllllllllllIIIIIIlIIlIlIlIIIIII);
                if (this.isThereOneNegativeScale(llllllllllllIIIIIIlIIlIlIlIIIlIl.getTransform(llllllllllllIIIIIIlIIlIlIlIIIIIl))) {
                    GlStateManager.cullFace(GlStateManager.CullFace.FRONT);
                }
            }
            CustomItems.setRenderOffHand(llllllllllllIIIIIIlIIlIlIlIIIIII);
            this.renderItem(llllllllllllIIIIIIlIIlIlIlIIlIIl, (IBakedModel)llllllllllllIIIIIIlIIlIlIlIIIIlI);
    ...
    public void renderItemIntoGUI(final ItemStack llllllllllllIIIIIIlIIlIlIIllIIIl, final float llllllllllllIIIIIIlIIlIlIIllIIII, final float llllllllllllIIIIIIlIIlIlIIlIllll) {
        this.func_191962_a(llllllllllllIIIIIIlIIlIlIIllIIIl, llllllllllllIIIIIIlIIlIlIIllIIII, llllllllllllIIIIIIlIIlIlIIlIllll, this.getItemModelWithOverrides(llllllllllllIIIIIIlIIlIlIIllIIIl, null, null));
    }
    
    protected void registerBlock(final Block llllllllllllIIIIIIlIIllIIIlIIIII, final int llllllllllllIIIIIIlIIllIIIIlllll, final String llllllllllllIIIIIIlIIllIIIIllllI) {
        this.registerItem(Item.getItemFromBlock(llllllllllllIIIIIIlIIllIIIlIIIII), llllllllllllIIIIIIlIIllIIIIlllll, llllllllllllIIIIIIlIIllIIIIllllI);
    }
    
    private void renderEffect(final IBakedModel llllllllllllIIIIIIlIIlIlllIIIIll) {
        if (!Config.isCustomItems() || CustomItems.isUseGlint()) {
            if (Main.featureDirector.getFeatureByClass(NoRender.class).isToggled() && NoRender.glintEffect.getBoolValue()) {
                return;
            }
            if (!Config.isShaders() || !Shaders.isShadowPass) {
                ...
                final float llllllllllllIIIIIIlIIlIlllIIIllI = Minecraft.getSystemTime() % 3000L / 3000.0f / 8.0f;
                GlStateManager.translate(llllllllllllIIIIIIlIIlIlllIIIllI, 0.0f, 0.0f);
                GlStateManager.rotate(-50.0f, 0.0f, 0.0f, 1.0f);
                if (Main.featureDirector.getFeatureByClass(EnchantmentColor.class).isToggled()) {
                    if (EnchantmentColor.colorMode.currentMode.equals("Rainbow")) {
                        this.func_191965_a(llllllllllllIIIIIIlIIlIlllIIIIll, DrawHelper.rainbow((int)llllllllllllIIIIIIlIIlIlllIIIllI, 1.0f, 1.0f).getRGB());
                    }
                    else if (EnchantmentColor.colorMode.currentMode.equals("Custom")) {
                        this.func_191965_a(llllllllllllIIIIIIlIIlIlllIIIIll, new Color(EnchantmentColor.customColor.getColorValue()).getRGB());
                    }
                    else if (EnchantmentColor.colorMode.currentMode.equals("Client")) {
                        this.func_191965_a(llllllllllllIIIIIIlIIlIlllIIIIll, ClientHelper.getClientColor().getRGB());
                    }
                }
                this.func_191965_a(llllllllllllIIIIIIlIIlIlllIIIIll, -8372020);
            }
            GlStateManager.popMatrix();
            GlStateManager.pushMatrix();
            GlStateManager.scale(8.0f, 8.0f, 8.0f);
            final float llllllllllllIIIIIIlIIlIlllIIIlIl = Minecraft.getSystemTime() % 4873L / 4873.0f / 8.0f;
            GlStateManager.translate(-llllllllllllIIIIIIlIIlIlllIIIlIl, 0.0f, 0.0f);
            GlStateManager.rotate(10.0f, 0.0f, 0.0f, 1.0f);
            if (Main.featureDirector.getFeatureByClass(EnchantmentColor.class).isToggled()) {
                if (EnchantmentColor.colorMode.currentMode.equals("Rainbow")) {
                    this.func_191965_a(llllllllllllIIIIIIlIIlIlllIIIIll, DrawHelper.rainbow((int)llllllllllllIIIIIIlIIlIlllIIIlIl, 1.0f, 1.0f).getRGB());
                }
                else if (EnchantmentColor.colorMode.currentMode.equals("Custom")) {
                    this.func_191965_a(llllllllllllIIIIIIlIIlIlllIIIIll, new Color(EnchantmentColor.customColor.getColorValue()).getRGB());
                }
    ...
    public IBakedModel getItemModelWithOverrides(final ItemStack llllllllllllIIIIIIlIIlIlIllIlIII, @Nullable final World llllllllllllIIIIIIlIIlIlIllIllll, @Nullable final EntityLivingBase llllllllllllIIIIIIlIIlIlIllIlllI) {
        final IBakedModel llllllllllllIIIIIIlIIlIlIllIllIl = this.itemModelMesher.getItemModel(llllllllllllIIIIIIlIIlIlIllIlIII);
        final Item llllllllllllIIIIIIlIIlIlIllIllII = llllllllllllIIIIIIlIIlIlIllIlIII.getItem();
        if (Config.isCustomItems()) {
            if (llllllllllllIIIIIIlIIlIlIllIllII != null && llllllllllllIIIIIIlIIlIlIllIllII.hasCustomProperties()) {
                this.modelLocation = llllllllllllIIIIIIlIIlIlIllIllIl.getOverrides().applyOverride(llllllllllllIIIIIIlIIlIlIllIlIII, llllllllllllIIIIIIlIIlIlIllIllll, llllllllllllIIIIIIlIIlIlIllIlllI);
            }
            final IBakedModel llllllllllllIIIIIIlIIlIlIllIlIll = CustomItems.getCustomItemModel(llllllllllllIIIIIIlIIlIlIllIlIII, llllllllllllIIIIIIlIIlIlIllIllIl, this.modelLocation, true);
            if (llllllllllllIIIIIIlIIlIlIllIlIll != llllllllllllIIIIIIlIIlIlIllIllIl) {
                return llllllllllllIIIIIIlIIlIlIllIlIll;
            }
        }
        if (Reflector.ForgeItemOverrideList_handleItemState.exists()) {
            return (IBakedModel)Reflector.call((Object)llllllllllllIIIIIIlIIlIlIllIllIl.getOverrides(), Reflector.ForgeItemOverrideList_handleItemState, new Object[] { llllllllllllIIIIIIlIIlIlIllIllIl, llllllllllllIIIIIIlIIlIlIllIlIII, llllllllllllIIIIIIlIIlIlIllIllll, llllllllllllIIIIIIlIIlIlIllIlllI });
        }
        if (llllllllllllIIIIIIlIIlIlIllIllII != null && llllllllllllIIIIIIlIIlIlIllIllII.hasCustomProperties()) {
            final ResourceLocation llllllllllllIIIIIIlIIlIlIllIlIlI = llllllllllllIIIIIIlIIlIlIllIllIl.getOverrides().applyOverride(llllllllllllIIIIIIlIIlIlIllIlIII, llllllllllllIIIIIIlIIlIlIllIllll, llllllllllllIIIIIIlIIlIlIllIlllI);
            return (llllllllllllIIIIIIlIIlIlIllIlIlI == null) ? llllllllllllIIIIIIlIIlIlIllIllIl : this.itemModelMesher.getModelManager().getModel(new ModelResourceLocation(llllllllllllIIIIIIlIIlIlIllIlIlI, "inventory"));
        }
        return llllllllllllIIIIIIlIIlIlIllIllIl;
    }
    
    public boolean shouldRenderItemIn3D(final ItemStack llllllllllllIIIIIIlIIlIllIIIlIIl) {
        final IBakedModel llllllllllllIIIIIIlIIlIllIIIlIII = this.itemModelMesher.getItemModel(llllllllllllIIIIIIlIIlIllIIIlIIl);
        return llllllllllllIIIIIIlIIlIllIIIlIII != null && llllllllllllIIIIIIlIIlIllIIIlIII.isGui3d();
    }
}
