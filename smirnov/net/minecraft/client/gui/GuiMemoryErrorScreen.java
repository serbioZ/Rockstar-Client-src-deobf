...
{
    @Override
    protected void keyTyped(final char lllllllllllllIllIIIlllIIIlllIIII, final int lllllllllllllIllIIIlllIIIllIllll) throws IOException {
    }
    
    @Override
    protected void actionPerformed(final GuiButton lllllllllllllIllIIIlllIIIlllIlII) throws IOException {
        if (lllllllllllllIllIIIlllIIIlllIlII.id == 0) {
            this.mc.displayGuiScreen(new GuiMainMenu());
        }
        else if (lllllllllllllIllIIIlllIIIlllIlII.id == 1) {
            this.mc.shutdown();
        }
    }
    
    @Override
    public void drawScreen(final int lllllllllllllIllIIIlllIIIllIlIIl, final int lllllllllllllIllIIIlllIIIllIlIII, final float lllllllllllllIllIIIlllIIIllIIIll) {
        ...
        super.drawScreen(lllllllllllllIllIIIlllIIIllIlIIl, lllllllllllllIllIIIlllIIIllIlIII, lllllllllllllIllIIIlllIIIllIIIll);
    }
